...
const TabSwitcher = () => {
    ...
    const { activeTab, setActiveTab, setLastOpenedTab } = useApp();
    ...
    return (
        <div className="fixed bottom-0 left-0 flex items-center justify-between px-4 py-3 bg-white shadow-md lg:hidden w-dvw md:px-8 dark:bg-neutral-950">
            <button onClick={() => handleClick("home")} className={`flex flex-col items-center gap-1 py-2 rounded-md w-20 dark:text-neutral-400 text-neutral-600 ${activeTab === "home" ? 'bg-blue-50 dark:bg-neutral-700 text-blue-500' : ''}`}>
            ...
            <div className="hidden md:block w-0.25 bg-neutral-200 dark:bg-neutral-800 h-12.5 mx-9.5"></div>

            <button onClick={() => handleClick("search")} className={`flex flex-col items-center gap-1 py-2 rounded-md w-20 dark:text-neutral-400 text-neutral-600 ${activeTab === "search" ? 'bg-blue-50 dark:bg-neutral-700 text-blue-500' : ''}`}>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <button onClick={() => handleClick("archived")} className={`flex flex-col items-center gap-1 py-2 rounded-md w-20 dark:text-neutral-400 text-neutral-600 ${activeTab === "archived" ? 'bg-blue-50 dark:bg-neutral-700 text-blue-500' : ''}`}>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                <span className="hidden text-xs md:block">Archived</span>
            </button>
            <div className="hidden md:block w-0.25 bg-neutral-200 dark:bg-neutral-800 h-12.5 mx-9.5"></div>

            <button onClick={() => handleClick("tags")} className={`flex flex-col items-center gap-1 py-2 rounded-md w-20 dark:text-neutral-400 text-neutral-600 ${activeTab === "tags" ? 'bg-blue-50 dark:bg-neutral-700 text-blue-500' : ''}`}>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
